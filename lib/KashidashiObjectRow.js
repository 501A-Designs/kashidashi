                ...
                >
                    {props.reserved ?
                        <AlignItems justifyContent={'space-between'}>
                            <AlignItems>
                                <span>今借りている人：{props.reservedBy}{props.reservedByEmail && <span style={{cursor: 'text'}}>（{props.reservedByEmail}）</span>}</span>
                            </AlignItems>
                            <AlignItems gap={'1em'}>
                                <span>借り始めた日時：{props.reservedTime}</span>
                                {props.reservedByUid &&
                                    <Button
                                        icon={<FiUser/>}
                        ...
                        <AlignItems justifyContent={'space-between'}>
                            <Button icon={<FiEdit/>} onClick={props.editButtonOnClick}>「{props.title}」を編集</Button>
                            <Button icon={<FiTrash2/>} onClick={props.removeButtonOnClick} accentColor={true}>「{props.title}」を消去</Button>
                        </AlignItems>
                    }
                </div>
            }
